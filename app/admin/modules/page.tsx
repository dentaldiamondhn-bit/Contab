...
const moduleStructure: Record<string, ModuleStructure> = {
  ACCOUNTING: {
    ...
    pages: [
      ...
      { label: 'Estados Financieros', path: '/accounting/financial-statements' },
      { label: 'Balance General', path: '/accounting/financial-statements/balance-general' },
      { label: 'Balance de Comprobación', path: '/accounting/financial-statements/balance-comprobacion' },
      { label: 'Estado de Resultados', path: '/accounting/financial-statements/estado-resultados' },
      { label: 'Flujo de Efectivo', path: '/accounting/financial-statements/flujo-efectivo' },
