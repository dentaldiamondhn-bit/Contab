  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-cyan-100 flex items-center justify-center p-4">
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-cyan-50 rounded-full mb-4 shadow-lg border border-cyan-200">
          <img src="/logo.png" alt="Diamond Accounting" className="h-10 w-10 object-contain" />
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Diamond Accounting</h1>
        <p className="text-gray-600 mb-4">Redirigiendo...</p>
        <div className="inline-flex items-center">
          <svg className="animate-spin h-5 w-5 mr-2 text-cyan-600" viewBox="0 0 24 24">
