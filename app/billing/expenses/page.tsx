...
export default function ExpensesPage() {
  ...
  const pendingInvoices = filtered.filter(i => i.status === 'PENDING').length;
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Facturas de proveedores de todas las empresas</p>
            </div>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">No hay facturas recibidas</p>
              </div>
            ) : (
