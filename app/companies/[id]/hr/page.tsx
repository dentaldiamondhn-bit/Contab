...
export default function HRDashboardPage() {
  ...
  const shortcuts = [
    ...
    },
    {
      ...
      description: 'Control de vacaciones, permisos personales, enfermedad y más',
      icon: Calendar,
      color: 'text-orange-600',
      bgColor: 'bg-orange-50',
      count: `${pendingVacations} pendientes`,
      path: '/hr/vacations'
    },
    {
      title: 'Reportes',
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">permisos por resolver</p>
          </CardContent>
        </Card>
      </div>
