...
export function CompanySwitcher({ tenants }: CompanySwitcherProps) {
  ...
  const getTenantStatus = (tenant: any) => {
    if (!tenant.isActive) return { variant: "destructive" as const, text: "Inactivo" };
    if (tenant.subscriptionType === "BASIC") return { variant: "secondary" as const, text: "Básico" };
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col items-start">
              <span className="truncate font-medium">{currentTenant?.businessName || "Seleccionar Empresa"}</span>
        ...
        <Command>
          <CommandList>
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex flex-col items-start flex-1">
                        ...
                        {tenant.businessRTN && (
                          <span className="text-xs text-muted-foreground">RTN: {tenant.businessRTN}</span>
                        )}
                        {tenant.industry && (
            ...
            <CommandGroup heading="Acciones">
              <CommandItem className="flex items-center gap-3 px-3 py-2">
