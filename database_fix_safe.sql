-- ========================================
-- VERSIÓN SEGURA - CORRECCIÓN DE BASE DE DATOS
-- ========================================
...
-- NOTA: Esto eliminará la vista tenant_plan_summary temporalmente
-- La recrearemos después de crear la tabla nueva
...
-- Paso 13: Recrear vista tenant_plan_summary con nueva estructura
...
-- Paso 18: Verificación final (separado para evitar errores de UNION)
...
-- Verificación de vistas (ejecutar por separado si hay errores)
...
-- Paso 19: Estructura de vistas (ejecutar por separado si hay errores)
-- Estructura de invoice_view
SELECT 
...
-- Estructura de invoice_item_view
SELECT 
...
-- Estructura de tenant_plan_summary
SELECT 
