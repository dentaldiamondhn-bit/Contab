-- Crear tablas necesarias para el onboarding (FINAL)
...
-- 5. Crear políticas de RLS básicas (CON CASTING)
-- NOTA: Convertir auth.uid() a TEXT para comparar con User.authid (TEXT)
