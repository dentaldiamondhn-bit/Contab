-- ========================================
-- MIGRACIÓN 005: TABLAS DE FACTURACIÓN CONSOLIDADA
-- ========================================
-- Crear tablas para persistencia de facturas creadas y recibidas
-- Autor: Sistema ContabHN
-- Fecha: 2026-05-12
-- Consolidado desde: 005_create_invoice_tables.sql y 005_create_invoice_tables_clean.sql
-- ========================================

-- Limpiar tablas existentes si hay errores previos (solo en desarrollo)
-- DROP TABLE IF EXISTS "InvoiceNote" CASCADE;
...
WHERE table_name IN ('Invoice', 'InvoiceItem', 'InvoicePayment', 'InvoiceNote')
...
-- 13. Estadísticas para optimización
ANALYZE "Invoice";
ANALYZE "InvoiceItem";
...
-- ========================================
-- FIN DE MIGRACIÓN 005 CONSOLIDADA
-- ========================================
