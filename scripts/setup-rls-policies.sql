...
-- =====================================================
-- POLÍTICAS PARA TABLA TRANSACTION
-- =====================================================

CREATE POLICY "tenant_isolation_transactions" ON "Transaction"
  FOR ALL
  TO authenticated
  USING ("tenantId" = get_current_tenant_id() OR is_super_admin());

-- =====================================================
-- POLÍTICAS PARA TABLA JOURNAL_ENTRY
-- =====================================================

CREATE POLICY "tenant_isolation_journal_entries" ON "JournalEntry"
  FOR ALL
  TO authenticated
  USING ("tenantId" = get_current_tenant_id() OR is_super_admin());

-- =====================================================
-- POLÍTICAS PARA TABLA CAI
-- =====================================================

CREATE POLICY "tenant_isolation_cai" ON "CAI"
  FOR ALL
  TO authenticated
  USING ("tenantId" = get_current_tenant_id() OR is_super_admin());

-- =====================================================
-- POLÍTICAS PARA TABLA INVOICE
-- =====================================================

CREATE POLICY "tenant_isolation_invoices" ON "Invoice"
  FOR ALL
  TO authenticated
  USING ("tenantId" = get_current_tenant_id() OR is_super_admin());

-- =====================================================
-- POLÍTICAS PARA TABLA FILE
-- =====================================================

CREATE POLICY "tenant_isolation_files" ON "File"
  FOR ALL
  TO authenticated
  USING ("tenantId" = get_current_tenant_id() OR is_super_admin());

-- =====================================================
-- POLÍTICAS PARA TABLA FILE_TEMPLATE
-- =====================================================

CREATE POLICY "tenant_isolation_file_templates" ON "FileTemplate"
  FOR ALL
  TO authenticated
  USING ("tenantId" = get_current_tenant_id() OR is_super_admin());
...
CREATE INDEX IF NOT EXISTS idx_account_tenant_id ON "Account"("tenantId");
CREATE INDEX IF NOT EXISTS idx_transaction_tenant_id ON "Transaction"("tenantId");
CREATE INDEX IF NOT EXISTS idx_journal_entry_tenant_id ON "JournalEntry"("tenantId");
CREATE INDEX IF NOT EXISTS idx_cai_tenant_id ON "CAI"("tenantId");
...
CREATE INDEX IF NOT EXISTS idx_file_template_tenant_id ON "FileTemplate"("tenantId");
