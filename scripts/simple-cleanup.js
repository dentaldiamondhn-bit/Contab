// Simple cleanup without environment variables
const fs = require('fs');
...
async function simpleCleanup() {
    console.log('🗑️ Starting simple Angel Ring cleanup...');
    ...
    const supabaseUrl = envVars.SUPABASE_URL.replace(/"/g, '');
    const supabaseKey = envVars.SUPABASE_SERVICE_ROLE_KEY;
    
    if (!supabaseUrl || !supabaseKey) {
        console.log('❌ Missing Supabase credentials in .env');
        console.log('📋 Found variables:', Object.keys(envVars).join(', '));
        return;
    }
